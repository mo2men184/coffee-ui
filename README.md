# Coffee UI - ☕ Coffee Shop App UI

Welcome to **Coffee UI**, a sleek and modern Flutter UI project for a coffee shop app. This project features well-structured components, clear data models, and reusable widgets. It's UI-only, making it perfect for easy reskinning and future logic integration.
...
![App Demo](preview/coffee.gif)

## 🤝 Contributing

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/mo2men184/coffee-ui/issues).
